...
//  Отказ - Булево
//
Процедура Записать(ИспользуемыеСтатусыДоски, Отказ = Ложь) Экспорт
...
Функция ДополнитьЗапросСтатусы(ТекстЗапросаСтатусы)
	...
	Оператор.Источники[0].Соединения.Добавить( 
		...
		"ИспользуемыеСтатусыДоски.СтатусЗадачи = СтатусыЗадачи.Ссылка И ИспользуемыеСтатусыДоски.Пользователь = &ТекущийПользователь");
