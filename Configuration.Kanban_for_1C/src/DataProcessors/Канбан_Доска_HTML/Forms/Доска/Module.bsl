...
//  ЗадачаСсылка - Неопределено, ОпределяемыйТип.канбан_Задачи - ссылка на задачу для оповещения.
//
&НаСервере
Процедура КанбанДоскаПриНажатииНаСервере(Знач ИдентификаторЗадача, Знач ИдентификаторСтатуса, ЗадачаСсылка)
	
	Отказ = Ложь;
	ЗадачаСсылка = канбан_КанбанДоска.ИзменитьСтатусЗадачи(ИдентификаторЗадача, ИдентификаторСтатуса, Отказ);
