...
Процедура КанбанДоскаПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Кнопка) Тогда
		...
		Если Кнопка.type = "INPUT" Тогда
			...
			// TODO тут возводим флаг что фильтры менялись. 
			// При любом обновлении доски, кроме как при создани на сервере, 
			// обновлять только задачи с учетом быстрых фильтров.
