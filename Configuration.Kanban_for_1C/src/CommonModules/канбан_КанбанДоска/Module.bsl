...
// 
Процедура ТекстHTMLКанбанДоски(КанбанДоска, УникальныйИдентификатор, ПоказыватьФотоПользователя = Истина) Экспорт
	
	Обработки.Канбан_Доска_HTML.ТекстHTMLКанбанДоски(КанбанДоска, УникальныйИдентификатор, ПоказыватьФотоПользователя);
