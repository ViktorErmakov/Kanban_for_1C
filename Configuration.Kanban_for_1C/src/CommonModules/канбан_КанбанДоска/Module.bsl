...
// 
// Параметры:
//  КанбанДоска - Строка - реквизит HTML страницы
// 
Процедура ТекстHTMLКанбанДоски(КанбанДоска) Экспорт
	
	Обработки.Канбан_Доска_HTML.ТекстHTMLКанбанДоски(КанбанДоска);
