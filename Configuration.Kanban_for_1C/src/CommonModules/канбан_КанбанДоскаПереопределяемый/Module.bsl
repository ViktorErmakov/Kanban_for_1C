...
Функция ТекстЗапросаДанныеЗадач() Экспорт
	...
	канбан_КанбанДоска.УстановитьОбъектЗапроса(Запрос.Текст, "канбан_Задачи", "&ОбъектЗапроса");
	канбан_КанбанДоска.УстановитьОбъектЗапроса(Запрос.Текст, "канбан_Проекты", "&ОбъектПроекты");
...
Функция ТекстЗапросаСтатусы() Экспорт
	...
	канбан_КанбанДоска.УстановитьОбъектЗапроса(Запрос.Текст, "канбан_СтатусыЗадач", "&ОбъектЗапроса");
