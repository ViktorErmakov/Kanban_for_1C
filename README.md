...
3. В менеджере объекта вашей канбан доски в событии *ОбработкаПолученияФормы* вызвать *канбан_КанбанДоска.ОбработкаПолученияФормы()*.
4. Для вашей формы канбан доски в расширении переопределить событие *ПриОткрытииПеред* обязательно перед срабатыванием основного события. Вызвать *канбан_КанбанДоскаКлиент.ПриОткрытииПеред(Отказ)*.